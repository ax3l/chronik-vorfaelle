...
var PruneClusterLeafletSpiderfier = ((<any>L).Layer ? (<any>L).Layer : L.Class).extend({
	_2PI: Math.PI * 2,
	_circleFootSeparation: 32, //org: 25, related to circumference of circle
	_circleStartAngle: Math.PI / 6,

	_spiralFootSeparation: 30, //org: 28, related to size of spiral (experiment!)
	_spiralLengthStart: 15, //org: 11
